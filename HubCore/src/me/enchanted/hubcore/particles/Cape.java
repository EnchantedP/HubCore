...
public class Cape  {
    ...
    public static boolean[][] shape1 = {
            ...
            {o, o, o, o, o, o, o, o, o, o, o, o, o, o, o, o},
            {o, o, o, o, o, o, o, o, o, o, o, o, o, o, o, o},
            {o, o, o, o, o, o, z, z, z, z, o, o, o, o, o, o},
            {o, o, o, o, o, o, z, z, z, z, o, o, o, o, o, o},
            {o, o, o, o, o, o, z, z, z, z, o, o, o, o, o, o},
            {o, o, o, o, o, o, z, z, z, z, o, o, o, o, o, o},
            {o, o, o, o, o, o, z, z, z, z, o, o, o, o, o, o},
    ...
    public static void drawParticles(Location location) {
        ...
        for (int i = 0; i < shape.length; i++) {
            for (int j = 0; j < shape[i].length; j++) {
                if (shape[i][j]) {
                    ...
                    location.add(v2);
                    for (int k = 0; k < 3; k++)
                    	location.getWorld().spawnParticle(Particle.REDSTONE, location.getX(), location.getY(), location.getZ(), 0, 0.750, 0, 0.750, 1);
        ...
        double space2 = 0.20;
        double defX2 = location.getX()-1.5;
        double x2 = defX2;
        ...
        for (int i = 0; i < shape1.length; i++) {
            for (int j = 0; j < shape1[i].length; j++) {
                if (shape1[i][j]) {
                    ...
                    location.add(v2);
                    for (int k = 0; k < 3; k++)
                    	location.getWorld().spawnParticle(Particle.REDSTONE, location.getX(), location.getY(), location.getZ(), 0, 255/255, 0, 255/255, 1);
                    location.subtract(v2);
                    location.subtract(v);
                }
                x2 += space2;
